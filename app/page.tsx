      ...
      <section className="relative overflow-hidden border-b border-black/10 text-white dark:border-white/10">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-24 text-center sm:py-32">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              href="#regioni"
              className="inline-flex w-40 items-center justify-center rounded-md bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition-colors hover:bg-zinc-200"
            >
              Esplora
            </a>
            <Link
              href="/registrati"
              className="inline-flex w-40 items-center justify-center rounded-md border border-white px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-white hover:text-zinc-900"
            >
              Registrati
            </Link>
          </div>
